    ...
    <section id="booking" className="relative py-32 md:py-48 bg-[#FDFBF7] overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-6 text-center z-10">
        ...
        >
          ...
          <h2 className="font-serif text-4xl md:text-6xl text-[#3E3832] font-medium leading-tight">
            Secure Your Sanctuary
          </h2>
          <p className="text-[#6B6359] text-lg md:text-xl font-light leading-relaxed">
        ...
        <motion.button
          ...
          className="group relative inline-flex items-center gap-4 bg-[#3E3832] text-warm-50 px-10 py-5 rounded-full overflow-hidden shadow-[0_10px_40px_-10px_rgba(62,56,50,0.3)] hover:shadow-[0_20px_50px_-10px_rgba(62,56,50,0.5)]"
        >
          <div className="absolute inset-0 w-full h-full bg-gradient-to-r from-transparent via-white/10 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000" />
          <Calendar size={20} className="group-hover:rotate-12 transition-transform duration-300" />
          <span className="text-sm md:text-base tracking-[0.2em] uppercase font-bold">
            Check Availability
          </span>
        ...
        {isOpen && (
          ...
          >
            <motion.div
              ...
              transition={{ duration: 0.5, ease: "easeOut" }}
              className="relative w-full h-full max-w-6xl max-h-[90vh] bg-white rounded-[2rem] md:rounded-[3rem] overflow-hidden shadow-2xl flex flex-col"
            ...
            >
              <div className="flex justify-between items-center px-8 py-6 border-b border-stone-100 bg-[#FAF8F5]">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-serif text-2xl text-[#3E3832] font-semibold leading-none">
                      Reserve Your Stay
                    </h3>
                    <p className="text-xs text-[#8B8173] mt-1">Select dates to proceed</p>
                  </div>
                </div>
                <button onClick={() => setIsOpen(false)}
                  className="p-3 rounded-full hover:bg-stone-200 text-stone-400 hover:text-stone-700 transition-colors duration-200">
                  <X size={24} />
                </button>
              </div>
